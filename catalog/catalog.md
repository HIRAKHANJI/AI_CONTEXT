...
- **Obsidian MCP (Local REST API + cyanheads)** — `Recommended` · ✅ · _MCP_ — read/write your vault from Claude. [↗](https://github.com/cyanheads/obsidian-mcp-server)
...
- **Ruflo (ex claude-flow)** — `Shortlist` · ✅ · _CLI_ — heavy multi-agent swarm framework; overkill for now. [↗](https://github.com/ruvnet/ruflo)
...
- **Semgrep CE (+ plugin)** — `Core` · ✅ · _CLI_ — multi-language SAST; auto-scans Claude's output. `pip install semgrep` [↗](https://github.com/semgrep/semgrep)
- **Betterleaks** — `Core` · ✅ · _CLI_ — modern secret scanner from gitleaks' creator. [↗](https://github.com/betterleaks/betterleaks)
- **gitleaks** — `Recommended` · ✅ · _CLI_ — proven secret scanner (watch governance split). `winget install gitleaks` [↗](https://github.com/gitleaks/gitleaks)
- **TruffleHog** — `Recommended` · ✅ · _CLI_ — finds & verifies live secrets in history. [↗](https://github.com/trufflesecurity/trufflehog)
...
- **eslint-plugin-security** — `Recommended` · ✅ · _CLI_ — JS/Node security rules. `npm i -D eslint-plugin-security` [↗](https://github.com/eslint-community/eslint-plugin-security)
...
- **accessible-color-contrast CLI** — `Situational` · ✅ · _CLI_ — inline WCAG contrast checks. `npx accessible-color-contrast #111 #fff` [↗](https://www.npmjs.com/package/accessible-color-contrast)
...
- **claude-mermaid MCP** — `Situational` · ✅ · _MCP_ — live preview/export while iterating. `claude mcp add claude-mermaid -- npx -y @veelenga/claude-mermaid` [↗](https://github.com/veelenga/claude-mermaid)
...
- **Obsidian Kanban plugin** — `Recommended` · ✅ · _Plugin_ — markdown boards in your vault, readable by Claude. [↗](https://github.com/obsidian-community/obsidian-kanban)
